<template>
  ...
  <!-- Mobile View -->
  <div class="md:hidden">
    <button @click="toggleDetails" class="w-full text-left p-3 -mx-3 active:bg-gray-50 rounded-lg touch-manipulation">
  ...
  <Teleport to="body">
    <Transition enter-active-class="transition duration-200 ease-out" enter-from-class="transform scale-95 opacity-0"
      ...
      <div v-if="isDetailsOpen" class="fixed inset-0 z-50 bg-black/20" @click="closeDetails">
